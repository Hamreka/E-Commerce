...
const {_id,createdAt,image,name,slug,updatedAt }=categ
    return <>
        ...
        <div className=' border-1 border-orange-500 rounded-none hover:shadow-xl  hover:shadow-orange-500  transition-shadow duration-500 cursor-pointer text-center '>
